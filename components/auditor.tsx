...
import { parseConfig, MAX_INPUT_BYTES } from '@/lib/parsers';
          ...
          <input
            ...
            onChange={async (e) => {
              ...
              try {
                ...
                setParseError('This file could not be read as text. Choose a plain-text configuration file and try again.');
              }
            }}
          />
        </label>
