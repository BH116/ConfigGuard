    ...
    <main className="mx-auto max-w-6xl space-y-10 p-6">
      <header className="space-y-4">
        <div className="flex items-start justify-between gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 590 140" fill="none" className="h-12 w-auto">
            ...
            <g transform="translate(160,0)" fontFamily="'Instrument Sans', system-ui, -apple-system, 'Helvetica Neue', Helvetica, Arial, sans-serif" fontWeight="600" fontSize="76" letterSpacing="-3.42">
              ...
              <text x="222" y="86" fill="#1f9d6b">Guard</text>
            </g>
          </svg>
          <ThemeToggle />
        </div>
      ...
      <footer className="space-y-2 border-t pt-4 text-sm">
        ...
        <p><a className="underline" href="/about">About</a> · <a className="underline" href="https://github.com/BH116/ConfigGuard" rel="noopener noreferrer">GitHub</a></p>
