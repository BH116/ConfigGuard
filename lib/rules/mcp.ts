...
/**
 * Checks MCP server configuration risks: untrusted sources or vulnerable versions, repo-controlled MCP mutation, dangerous launch commands, mutable/unpinned refs, and untrusted skill or extension scripts.
 *
 * @param parsed - The parsed config to scan.
 * @returns Findings for MCP server misconfigurations.
 */
