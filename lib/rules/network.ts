...
/**
 * Checks network security controls: disabled TLS verification, missing output sanitization or image autoload controls, and vendor telemetry sending data off-host.
 *
 * @param parsed - The parsed config to scan.
 * @returns Findings for network and transport misconfigurations.
 */
