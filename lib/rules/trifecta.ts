...
/**
 * Detects the lethal trifecta: untrusted input ingestion, sensitive data access, and an outbound exfiltration channel all present in one config.
 *
 * @param parsed - The parsed config to scan.
 * @returns A single AGT-001 finding when all three legs are detected, otherwise an empty array.
 */
