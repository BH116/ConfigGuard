...
/**
 * Checks agent workflow risks: hooks running untrusted input, auto-commit without verify, trivially weak rules files, self-modifying instructions, and sensitive files missing ignore coverage.
 *
 * @param parsed - The parsed config to scan.
 * @returns Findings for workflow and lifecycle misconfigurations.
 */
