...
/**
 * Checks for hardcoded secrets: known provider key formats, high-entropy credential values, and sensitive env variable names with literal values.
 *
 * @param parsed - The parsed config to scan.
 * @returns Findings for hardcoded or plaintext secrets.
 */
